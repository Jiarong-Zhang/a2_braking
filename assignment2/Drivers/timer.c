...
/**
 * File name: timer.h
 * Description: Function implementation for operations related to the C167
 *timers
 **/
...
void timerT6Config(unsigned int prescaler, unsigned int mode,
...
void timerT3Config(unsigned int prescaler, unsigned int mode,
                   unsigned int direction) {
  // set prescaler
